...
foreach($_SERVER['modules'] as $module){
    array_push($array, array(json_decode(file_get_contents($module.'/app.json'), true)['module_name'], json_decode(file_get_contents($module.'/app.json'), true)['module_route'], $module));
}
